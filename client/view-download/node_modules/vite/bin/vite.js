#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/Users/jhonatanalmanza/.vscode/extensions/wallabyjs.console-ninja-1.0.464/out/buildHook/index.js').default({tool: 'vite', checkSum: '203273eab181ee2e1db9edBBwGHVRbB1RZBFJVAgNXAAQBBlcE', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/jhonatanalmanza/.vscode/extensions/wallabyjs.console-ninja-1.0.464/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '203273eab181ee2e1db9edBBwGHVRbB1RZBFJVAgNXAAQBBlcE', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
